...
| budgets | stylesheet 18.9 KB, shipped compressed (24.1 KB before, which broke the budget), script 3.3 KB, font 23.6 KB, preview image 62.5 KB, largest page 39 KB, `start-from-an-idea` (was 67 KB, the guide, now removed) (CI) | holds |
