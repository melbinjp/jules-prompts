...
*   [List specific, non-negotiable requirements. E.g., "The endpoint must use the standard authentication middleware.", "All new code must have 100% unit test coverage."]
*   [List any constraints or things to avoid. E.g., "Do not introduce any new dependencies without prior approval.", "Do not alter the existing database schema."]
...
**Deliverables:**
*   [List the expected artifacts. E.g., "A new file `src/api/user_profile.js` with the new endpoint.", "Updated unit tests in `src/api/user_profile.test.js`.", "A new entry in the API documentation."]
