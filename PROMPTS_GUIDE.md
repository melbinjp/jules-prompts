...
### [`template_master_prompt.md`]({% link template_master_prompt.md %})
...
### [`task_audit_repo.md`]({% link task_audit_repo.md %})
...
### [`task_harden_repo_initial.md`]({% link task_harden_repo_initial.md %})
...
### [`task_harden_repo_iterative.md`]({% link task_harden_repo_iterative.md %})
...
### [`task_fix_and_refine.md`]({% link task_fix_and_refine.md %})
...
### [`task_update_dependencies.md`]({% link task_update_dependencies.md %})
...
### [`task_curate_repo.md`]({% link task_curate_repo.md %})
