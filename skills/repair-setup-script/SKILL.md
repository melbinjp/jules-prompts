...
description: 'To diagnose and repair the setup script so agent tasks stop failing
  before any code is written. Category: Initial Scoping.'
license: MIT
metadata:
  prompt_slug: task_repair_setup_script
  source: _prompts/task_repair_setup_script.md
