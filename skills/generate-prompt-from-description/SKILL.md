...
description: 'To generate a new, high-quality prompt from a user''s description. Category:
  Meta.'
license: MIT
metadata:
  prompt_slug: task_generate_prompt_from_description
  source: _prompts/task_generate_prompt_from_description.md
