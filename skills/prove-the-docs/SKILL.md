---
name: prove-the-docs
description: 'To find the claims in the docs that were true when written and are not
  true now, by executing each one rather than reading it. Category: Maintenance.'
license: MIT
metadata:
  prompt_slug: task_prove_the_docs
  source: _prompts/task_prove_the_docs.md
