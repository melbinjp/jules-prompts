...
description: 'To find the CI steps that pass because they are not running what they
  claim, and make each one able to fail again. Category: Maintenance.'
license: MIT
metadata:
  prompt_slug: task_repair_a_green_pipeline
  source: _prompts/task_repair_a_green_pipeline.md
