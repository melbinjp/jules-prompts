---
name: audit-repo
description: 'To conduct a comprehensive, evidence-based audit of a repository or
  live website. Category: Initial Scoping.'
license: MIT
metadata:
  prompt_slug: task_audit_repo
  source: _prompts/task_audit_repo.md
