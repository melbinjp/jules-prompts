...
description: To review a change an agent wrote for the security defects agents specifically
  introduce.
license: MIT
metadata:
  prompt_slug: task_security_review_agent_code
  source: _prompts/task_security_review_agent_code.md
