---
name: prove-the-fix
description: 'To establish that a test added alongside a fix actually detects the
  defect, by putting the defect back and watching the test go red. Category: Maintenance.'
license: MIT
metadata:
  prompt_slug: task_prove_the_fix
  source: _prompts/task_prove_the_fix.md
