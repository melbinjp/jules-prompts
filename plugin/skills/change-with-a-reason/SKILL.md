...
metadata:
  ...
  source: _prompts/task_change_with_a_reason.md
...
*   **Translate each claim into its measurable meanings, and map each meaning to the ledger.**
    ...
    *   **"Prettier", "more intuitive", "cleaner":** which journey, for whom, and where do people hesitate, err or give up? Task success, time and errors on that journey, with people (`design-the-experience`); a look the owner wants is a taste call they make between rendered options.
