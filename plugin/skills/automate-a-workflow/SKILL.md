...
description: 'To replace a repeated manual sequence with a script whose main job is
  being able to tell you whether the work actually happened, because an automation
  that reports success while blind is worse than doing it by hand. Category: Iterative
  Development.'
license: MIT
metadata:
  prompt_slug: task_automate_a_workflow
  source: _prompts/task_automate_a_workflow.md
