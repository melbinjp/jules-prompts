...
description: 'To take a product that meets its bar to the people it is for, and hear
  back. Every way in is walked from a clean device, listings and legal texts match
  the product, the release is staged and pauses itself, people are told where they
  already are, and someone answers. A quiet channel gets the next route, never a verdict
  on the idea. Category: Lifecycle.'
license: MIT
metadata:
  prompt_slug: task_release_to_people
  source: _prompts/task_release_to_people.md
  title: Release a Product to Its People, and Hear Back
  category: Lifecycle
---

# Release a Product to Its People, and Hear Back
