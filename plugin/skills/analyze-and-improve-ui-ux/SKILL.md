...
description: 'To review a web frontend''s UI/UX against usability heuristics. For
  design work, use design-the-experience. Category: Iterative Development. Legacy:
  general-purpose, kept for completeness.'
license: MIT
metadata:
  prompt_slug: task_analyze_and_improve_ui_ux
  source: _prompts/task_analyze_and_improve_ui_ux.md
