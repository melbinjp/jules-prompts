...
- The shared calendar: nothing stops an overlapping event.
- A hosted Postgres: £7 to £15 a month, over M3 on its own.
- One SQLite file, with a unique index on (machine, day, slot).

## Evidence

- Calculation: at most 50 bookings a day is 18,000 rows a year.
- Measured: 200 concurrent attempts on one slot gave 1 booking and 199 refusals.

## Decision

SQLite, with the unique index doing the refusing.
