...
works on any phone or computer. It breaks all three, and it is unfinished in the
ways no test catches. Seven defects are planted. The dark theme is done right and
is the control.
